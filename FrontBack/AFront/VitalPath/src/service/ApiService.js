...
export default class ApiService {
  ...
  // === Notifications ===
  // === Notifications ===
  // Notification endpoints have been removed from the backend; frontend API methods were removed accordingly.

  // === Chat API ===
  // === Chat API ===
  // Chat-related endpoints were removed from the backend; frontend API methods removed.
  ...
  // === Reviews ===
  // === Reviews ===
  // Review endpoints were removed; corresponding frontend methods removed to avoid calling nonexistent APIs.
