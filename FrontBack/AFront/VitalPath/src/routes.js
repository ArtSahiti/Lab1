...
// Chat, Reviews, and Notifications have been removed from backend — UI routes removed
...
const therapistRoutes = [
  ...
  // ProfessionalReviews removed because backend does not provide review endpoints
];
...
const getRoutesByRole = () => {
  ...
  switch (role) {
    case "THERAPIST":
      routes = [...therapistRoutes, ...appointmentRoutes, ...hiddenRoutes];
      break;
    case "USER":
      routes = [...userRoutes, ...appointmentRoutes, ...hiddenRoutes];
      break;
    case "ADMIN":
      routes = [...adminRoutes, ...hiddenRoutes];
      break;
    case "NUTRICIST":
      routes = [...nutritionistRoutes, ...appointmentRoutes, ...hiddenRoutes];
      break;
    default:
      routes = [...hiddenRoutes];
  }
